...
Designers of the ESM envisioned that a Maker defense team re-launch the protocol. A new MKR distribution would need to be specified that re-issues the MKR burnt in triggering ESM and burns the MKR used to launch the attack. Although some of the attacking MKR might have been borrowed, [MKR holders have voted to burn all involved tokens](https://vote.makerdao.com/polling/QmPaNqm4?network=mainnet#vote-breakdown). Therefore, a considerable amount of attacking MKR would be burnt. If this new MKR token, and associated Maker re-deployment, was accepted by the community, this new MKR distribution would grant substantial profits to non-attacking MKR.
