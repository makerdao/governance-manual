...
The System Surplus Buffer does not hold real ERC-20 DAI, but is an accounting fiction. This distinction comes into play during Emergency Shutdown. Value backing outstanding DAI will include System Surplus Buffer worth of excess collateral. Therefore, 1 DAI will be worth slightly more than 1 USD. Although Maker Governance can withdraw value from the System Surplus Buffer at any time, the System Surplus Buffer is not owned by Maker Governance, but by DAI holders.
